...
* Automatic order checking in the background
* Customizable notification sounds
* Control request frequency with "Requests per Minute" setting
...
3. Go to WooCommerce > Order Notifier to configure your notification settings.
4. Choose your preferred notification sound and adjust the volume.
5. Set up any custom rules for order notifications (Pro feature).
6. Save your settings and start receiving instant order alerts!
...
Yes, Pro users can upload custom audio files to use as notification sounds.
